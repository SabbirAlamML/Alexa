...
14. Copy the ARN from the top right to be used later in the Alexa Skill Setup. (arn:aws:lambda:us-east-1:163165220712:function:Hello-Sabbir-Example-Skill)
